    ...
    <div class="layui-fluid">
        <div class="layui-table" style="margin-top:30px;">
            <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
                <legend style="padding-top: 10px;">学生查询</legend>
            </fieldset>
         ...
         <div class="site-demo-button" id="layerDemo" style="margin-bottom: 0;">
			  <button class="layui-btn" data-method="setTop">新增学生</button>
		 </div>
        ...
        layui.config({
            ...
            table.render({
                ...
                , cols: [[ //标题栏
                    ...
                    , { field: 'userId', title: '学生Id', align: 'center', width: 200 }
                    , { field: 'userName', title: '学生姓名', align: 'center',edit: 'text', width: 200 }
