          ...
          <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            <div class="layui-form-item">
              <div class="layui-inline">
               ...
               <input type="text" name="classes.classId" placeholder="请输入" autocomplete="off" class="layui-input">
              </div>
            </div>
            <div class="layui-inline">
             <label class="layui-form-label">课程名</label>
             <div class="layui-input-block">
              <input type="text" name="classes.className" placeholder="请输入" autocomplete="off" class="layui-input">
             </div>
           </div>
          <div class="layui-inline">
            <label class="layui-form-label">任课老师</label>
            <div class="layui-input-block">
              <input type="text" name="classes.teacher" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
          </div>
          <div class="layui-inline">
            <button class="layui-btn layuiadmin-btn-useradmin" lay-submit lay-filter="searchButton" id="searchButton">
    ...
    <script type="text/JavaScript">
        layui.config({
            ...
            table.render({
                ...
                , cols: [[ //标题栏
                    { field: 'classId', title: '课程Id', align: 'center', width: 100 }
                    , { field: 'className', title: '课程名', align: 'center', width: 100 }
                    , { field: 'teacher', title: '任课教师', align: 'center', width: 100 }
                    , { field: 'classBeginDate', title: '课程开始时间', align: 'center', width: 100 }
                    , { field: 'classEndDate', title: '课程结束时间', align: 'center', width: 100 }
                ]]
	            , page: true
	            , limit: 50
	            , cellMinWidth: 80
